...
<div class="card-body">
  ...
  <h5 class="card-subtitle mb-2 text-muted">Commande numéro : ${confirmationCommande.orderId}</h5>
  ...
  <p class="card-text">${confirmationContact.lastName} ${confirmationContact.firstName}
  Merci d'avoir commandé chez nous.<br/> Nous pensons que vous serez satisfaits
  de la qualité de nos produits.<br/> C'est bien cette qualité qui nous différencie de nos concurrents.<br/>
  </p>
  <p class="recap">Voici le prix total de votre commande : <strong>${confirmationPrix}€</strong></p>
  <button class="btn-fermer" onclick="closeModal()"><a href="index.html" class="card-link">Fermer</a></button>
</div>
`;
